...
function create_page(content){
    ...
    btn_configuration.addEventListener('click' , function(){
        ...
        setTimeout(() => {
            ...
            console.log(JSON.parse(window.sessionStorage.product));
            console.log("====>" , content)
            document.body.innerHTML += ` 
                <div class="display">
                    ...
                    <h2 class = "chop_card">عربه التسوق</h2>
                </div>
            `
            setTimeout(() => {
...
document.body.addEventListener('click' , function(e){
    if(e.target.className === "chopping" || e.target.className ==="chop_card"){
        window.open('http://127.0.0.1:5500/css_default/sign.html');
    }
})